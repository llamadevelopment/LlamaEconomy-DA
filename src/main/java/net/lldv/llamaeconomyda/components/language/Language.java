package net.lldv.llamaeconomyda.components.language;
...
public class Language {
    ...
    public static void init(LlamaEconomyDA economyDA) {
        messages.clear();
        economyDA.saveResource("messages.yml");
        Config m = new Config(economyDA.getDataFolder() + "/messages.yml");
